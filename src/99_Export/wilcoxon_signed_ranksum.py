...
wd   = pd.read_csv("wilcoxon_paired_summary.tsv", sep="\t")
...
if len(sig_labels) > 0:
    ...
    for label in sig_labels:
        ...
        sub["Wilcoxon Signed Rank Test___p-value"] = pval
...
styles+=["ws.column_dimensions[get_column_letter(7)].width = 25","ws.column_dimensions[get_column_letter(8)].width = 10","ws.column_dimensions[get_column_letter(9)].width = 15",
"ws.column_dimensions[get_column_letter(10)].width = 15","ws.column_dimensions[get_column_letter(11)].width = 10"]
